...
export const nextCohortStartDate = 'October 8, 2019'
...
export const leadContent = {
    ...
    paragraph: `${schoolName} designs its programs to prepare students for a career as a lineworker. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        ...
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKNALTC18",
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $10,830 for tuition & supplemental costs (certification, equipment, tools, & CDL fee)."
