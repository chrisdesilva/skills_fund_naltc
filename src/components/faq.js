          ...
          <Collapse isOpened={q1} springConfig={{stiffness: 150, damping: 30}}>
               <ul className="mb-0 pb-4">
                    {faq.loanRange.map(program => {
                         return <li>
                              <strong>For {program.programName},</strong> you may borrow from $2,000 up to {program.maxAmount} for tuition & supplemental costs (certification, equipment, tools, & CDL fee).
                         </li>
                    })}
               </ul>
